...
def_event_label_vis = SHOWHIDE.HIDE
...
optional.add_argument("-b_v", "--border_vis", type=SHOWHIDE, default=def_border_vis, choices=list(SHOWHIDE), help="Controls whether the border of the map is rendered as a line.  Must be either \"show\" or \"hide\" (e.g. -bv \"show\").  Default: \"%s\".\n\n" % def_border_vis)

optional.add_argument("-b_s", "--border_size", type=int, default=def_border_size, help="Width of rendered map border lines.  Default: \"%.1f\".\n\n" % def_border_size)

optional.add_argument("-b_c", "--border_colour", type=str, default=def_border_colour, help="Colour of rendered map border lines.  Can be specified as colour names (e.g. \"black\"), as hex values (e.g. \"#16C3D6\" for a light blue) or as rgb values in the range 0-255 (e.g. \"rgb(128,0,128)\" for purple).  Default: \"%s\".\n\n" % def_border_colour)

optional.add_argument("-al_v", "--axis_label_vis", type=SHOWHIDE, default=def_axis_label_vis, choices=list(SHOWHIDE), help="Controls whether the axis labels (\"Top strand\" and \"Bottom strand\") are rendered.  Must be either \"show\" or \"hide\" (e.g. -alv \"show\").  Default: \"%s\".\n\n" % def_axis_label_vis)

optional.add_argument("-al_s", "--axis_label_size", type=int, default=def_axis_label_size, help="Font size of axis labels.  Default: \"%.1f\".\n\n" % def_axis_label_size)

optional.add_argument("-al_c", "--axis_label_colour", type=str, default=def_axis_label_colour, help="Colour of the rendered axis labels.  Can be specified as colour names (e.g. \"black\"), as hex values (e.g. \"#16C3D6\" for a light blue) or as rgb values in the range 0-255 (e.g. \"rgb(128,0,128)\" for purple).  Default: \"%s\".\n\n" % def_axis_label_colour)

optional.add_argument("-al_g", "--axis_label_gap", type=float, default=def_axis_label_gap, help="Gap between axis labels and the top/left edges of the map region (allowances must be made for grid labels if enabled).  Specified in integer pixel units.  Default: \"%i\".\n\n" % def_axis_label_gap)

optional.add_argument("-g_v", "--grid_vis", type=SHOWHIDE, default=def_grid_vis, choices=list(SHOWHIDE), help="Controls whether grid lines are rendered.  Must be either \"show\" or \"hide\" (e.g. -gv \"show\").  Default: \"%s\".\n\n" % def_grid_vis)
...
optional.add_argument("-gl_v", "--grid_label_vis", type=SHOWHIDE, default=def_grid_label_vis, choices=list(SHOWHIDE), help="Controls whether grid labels are rendered.  Grid labels are always shown above the top strand and are rotated vertically.  Must be either \"show\" or \"hide\" (e.g. -glv \"show\").  Default: \"%s\".\n\n" % def_grid_label_vis)
...
optional.add_argument("-gl_g", "--grid_label_gap", type=float, default=def_grid_label_gap, help="Gap between grid labels and the rendered DNA strands.  Specified in integer pixel units.  Default: \"%i\".\n\n" % def_grid_label_gap)
...
optional.add_argument("-el_v", "--event_label_vis", type=SHOWHIDE, default=def_event_label_vis, choices=list(SHOWHIDE), help="Controls whether the event labels (showing percentage of total events) are rendered.  Must be either \"show\" or \"hide\" (e.g. -elv \"show\").  Default: \"%s\".\n\n" % def_event_label_vis)

optional.add_argument("-el_s", "--event_label_size", type=int, default=def_event_label_size, help="Font size of event labels.  Default: \"%.1f\".\n\n" % def_event_label_size)

optional.add_argument("-el_c", "--event_label_colour", type=str, default=def_event_label_colour, help="Colour of the rendered event labels.  Can be specified as colour names (e.g. \"black\"), as hex values (e.g. \"#16C3D6\" for a light blue) or as rgb values in the range 0-255 (e.g. \"rgb(128,0,128)\" for purple).  Event labels have the special colour option \"invert\", which uses the opposite RGB colour to the corresponding event square to improve label contrast.  Default: \"%s\".\n\n" % def_event_label_colour)

optional.add_argument("-el_dp", "--event_label_decimal_places", type=int, default=def_event_label_decimal_places, help="Number of decimal places to use when displaying event frequencies.")

optional.add_argument("-el_zv", "--event_label_zeros_vis", type=SHOWHIDE, default=def_event_label_zeros_vis, choices=list(SHOWHIDE), help="Controls whether labels for positions with zero events are rendered.  Showing these labels can greatly increase file size - especially when rendering a large position range.  Must be either \"show\" or \"hide\" (e.g. -elzv \"show\").  Default: \"%s\".\n\n" % def_event_label_zeros_vis)

optional.add_argument("-s_v", "--sum_vis", type=SHOWHIDE, default=def_sum_vis, choices=list(SHOWHIDE), help="Controls whether the sum row and columns are rendered.  These event cells are rendered using the same settings as for standard events (e.g. font size, colour and zeros visibility).  Must be either \"show\" or \"hide\" (e.g. -sv \"show\").  Default: \"%s\".\n\n" % def_sum_vis)
