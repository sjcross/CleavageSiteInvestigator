...
bubble_outline_sense = "blue"
bubble_outline_rc = "red"
bubble_width = 3
bubble_w = 0.05
bubble_h = 0.03
...
def animate_rotation(window, canvas, cx, cy, angle_degs, duration, tag):
    n_frames = duration*fps
...
create_bubble(canvas,cass_x1,cass_y1-bubble_h/2,cass_x1+bubble_w,cass_y1+bubble_h/2,bubble_outline=bubble_outline_sense,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["bubble"])
create_bubble(canvas,cass_x1,cass_y1-bubble_h/2,cass_x1+bubble_w,cass_y1+bubble_h/2,bubble_outline=bubble_outline_sense,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["static_bubble","cass_seq_dna"])
animate_pause(window,1)
...
create_bubble(canvas,match_pos_1-bubble_h/2,test_y1-bubble_h/2,match_pos_1+bubble_w/2,test_y1+bubble_h/2,bubble_outline=bubble_outline_sense,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["candidate","score_fail"])
...
create_bubble(canvas,match_pos_2-bubble_h/2,test_y1-bubble_h/2,match_pos_2+bubble_w/2,test_y1+bubble_h/2,bubble_outline=bubble_outline_sense,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["candidate","score_fail"])
...
create_bubble(canvas,match_pos_3-bubble_h/2,test_y1-bubble_h/2,match_pos_3+bubble_w/2,test_y1+bubble_h/2,bubble_outline=bubble_outline_sense,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["candidate","score_pass"])
...
animate_rotation(window,canvas,0.5,cass_yc,180,1,"cass_seq_dna")
canvas.itemconfigure("cass_seq_text",text="Cassette sequence (RC)")
create_bubble(canvas,cass_x1,cass_y1-bubble_h/2,cass_x1+bubble_w,cass_y1+bubble_h/2,bubble_outline=bubble_outline_rc,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["bubble"])
create_bubble(canvas,cass_x1,cass_y1-bubble_h/2,cass_x1+bubble_w,cass_y1+bubble_h/2,bubble_outline=bubble_outline_rc,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["static_bubble","cass_seq_dna"])
animate_pause(window,1)
...
match_pos_1 = 0.2
animate_motion(window,canvas,0.12,test_y1,match_pos_1,test_y1,step_size,"bubble")
create_bubble(canvas,match_pos_1-bubble_h/2,test_y1-bubble_h/2,match_pos_1+bubble_w/2,test_y1+bubble_h/2,bubble_outline=bubble_outline_rc,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["candidate","score_pass_temp"])
create_text(canvas, match_pos_1, test_y1-0.05, "98% match", dna_font, tags=["score_text","score_pass_temp"])

match_pos_2 = 0.54
animate_motion(window,canvas,match_pos_1,test_y1,match_pos_2,test_y1,step_size,"bubble")
create_bubble(canvas,match_pos_2-bubble_h/2,test_y1-bubble_h/2,match_pos_2+bubble_w/2,test_y1+bubble_h/2,bubble_outline=bubble_outline_rc,bubble_width=bubble_width,dna_fill=cass_seq_fill,dna_width=dna_width,tags=["candidate","score_fail"])
create_text(canvas, match_pos_2, test_y1-0.05, "94% match", dna_font, tags=["score_text","score_fail"])

animate_motion(window,canvas,match_pos_2,test_y1,test_x2,test_y1,step_size,"bubble")
canvas.delete("bubble")
animate_pause(window,1)
