...
python .\src\csi.py -c $cass_path -r $ref_path -t "D:\Stephen\People\Oscar\2020-02-20 Sequencing analysis\2021-02-23 Circularity test data\Test Data set\BsaITAQ11.fasta" -en 3 -v -pr -wi -ws
