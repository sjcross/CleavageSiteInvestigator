...
python .\src\csi.py -c $cass_path -r $ref_path -t "\\LUCA\People\Oscar\2020-02-20 Sequencing analysis\2020-10-28 Problem files\Stop Error\XbaINEBH.fasta" -en 3 -rf 'x>=4' -pr -we -wo -wi -ws
